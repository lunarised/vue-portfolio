  ...
  <section class="resume-section p-3 p-lg-5 d-flex align-items-center" id="home">
    <div class="w-100">
      ...
      <p>
        ...
        and had various experiences managing systems, such as managing SSL certificates,
        Diagnosing hardware faults, and general maintenance of several systems used by the
        other students for their projects.
      </p>
    </div>
  </section>
</template>
